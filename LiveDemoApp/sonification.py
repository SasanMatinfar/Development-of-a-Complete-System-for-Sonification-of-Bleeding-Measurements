...
buffers = [
    ...
    sc.Buffer().load_file("samples/seagulls_tuned.wav"),
    sc.Buffer().load_file("samples/bell.wav"),
    sc.Buffer().load_file("samples/bell2.wav"),
    sc.Buffer().load_file("samples/Kalimba_Dry_fadeIO.wav"),
]
...
# buffer in SC
sc.cmd("""
~b = Buffer.read(s, "/Users/sasan/Desktop/MasterThesis/arduinoserial/LiveDemoApp/samples/bell.wav");
""")
...
pad_volume_range = [2.5, 10]
tau4_amp_range = [0, 0.5]  #
tau4_rate = 1
th_tau4 = 3
clock_event_amp = 0.03  #
...
slider_marimba_amp_min = QSlider(Qt.Horizontal)
slider_marimba_amp_min.setFocusPolicy(Qt.StrongFocus)
slider_marimba_amp_min.setTickPosition(QSlider.TicksAbove)
slider_marimba_amp_min.setTickInterval(10)
slider_marimba_amp_min.setSingleStep(1)

slider_pad_volume_min = QSlider(Qt.Horizontal)
slider_pad_volume_min.setFocusPolicy(Qt.StrongFocus)
slider_pad_volume_min.setTickPosition(QSlider.TicksAbove)
slider_pad_volume_min.setTickInterval(10)
slider_pad_volume_min.setSingleStep(1)

slider_th_tau4 = QSlider(Qt.Horizontal)
slider_th_tau4.setFocusPolicy(Qt.StrongFocus)
slider_th_tau4.setTickPosition(QSlider.TicksAbove)
slider_th_tau4.setTickInterval(10)
slider_th_tau4.setSingleStep(1)


def slider_clock_amp_changed():
    global clock_event_amp
    value = slider_clock_event_amp.value() / 400
    line_edit_clock_amp.setText(str(value))
    clock_event_amp = value


def slider_marimba_amp_min_changed():
    global marimba_amp_range
    value = slider_marimba_amp_min.value() / 200
    line_edit_marimba_amp_min.setText(str(value))
    marimba_amp_range[0] = value


def slider_pad_volume_min_changed():
    global pad_volume_range
    value = slider_pad_volume_min.value() / 10
    line_edit_pad_volume_min.setText(str(value))
    pad_volume_range[0] = value


def slider_th_tau4_changed():
    global th_tau4
    value = slider_th_tau4.value() / 10
    line_edit_th_tau4.setText(str(value))
    th_tau4 = value


label_clock_amp = QLabel('clock event amp')
layout_left.addWidget(label_clock_amp)
slider_clock_event_amp.valueChanged.connect(slider_clock_amp_changed)
layout_left.addWidget(slider_clock_event_amp)
line_edit_clock_amp = QLineEdit()
line_edit_clock_amp.setText(str(clock_event_amp))
layout_left.addWidget(line_edit_clock_amp)

label_marimba_amp_min = QLabel('marimba amp min')
layout_left.addWidget(label_marimba_amp_min)
slider_marimba_amp_min.valueChanged.connect(slider_marimba_amp_min_changed)
layout_left.addWidget(slider_marimba_amp_min)
line_edit_marimba_amp_min = QLineEdit()
line_edit_marimba_amp_min.setText(str(marimba_amp_range[0]))
layout_left.addWidget(line_edit_marimba_amp_min)

label_pad_volume_min = QLabel('pad volume min')
layout_left.addWidget(label_pad_volume_min)
slider_pad_volume_min.valueChanged.connect(slider_pad_volume_min_changed)
layout_left.addWidget(slider_pad_volume_min)
line_edit_pad_volume_min = QLineEdit()
line_edit_pad_volume_min.setText(str(pad_volume_range[0]))
layout_left.addWidget(line_edit_pad_volume_min)

label_th_tau4 = QLabel('threshold seagulls')
layout_left.addWidget(label_th_tau4)
slider_th_tau4.valueChanged.connect(slider_th_tau4_changed)
layout_left.addWidget(slider_th_tau4)
line_edit_th_tau4 = QLineEdit()
line_edit_th_tau4.setText(str(th_tau4))
layout_left.addWidget(line_edit_th_tau4)

# right layout
slider_tau4_amp_max = QSlider(Qt.Horizontal)
slider_tau4_amp_max.setFocusPolicy(Qt.StrongFocus)
slider_tau4_amp_max.setTickPosition(QSlider.TicksAbove)
slider_tau4_amp_max.setTickInterval(10)
slider_tau4_amp_max.setSingleStep(1)

slider_marimba_amp_max = QSlider(Qt.Horizontal)
slider_marimba_amp_max.setFocusPolicy(Qt.StrongFocus)
slider_marimba_amp_max.setTickPosition(QSlider.TicksAbove)
slider_marimba_amp_max.setTickInterval(10)
slider_marimba_amp_max.setSingleStep(1)

slider_pad_volume_max = QSlider(Qt.Horizontal)
slider_pad_volume_max.setFocusPolicy(Qt.StrongFocus)
slider_pad_volume_max.setTickPosition(QSlider.TicksAbove)
slider_pad_volume_max.setTickInterval(10)
slider_pad_volume_max.setSingleStep(1)

slider_tau4 = QSlider(Qt.Horizontal)
slider_tau4.setFocusPolicy(Qt.StrongFocus)
slider_tau4.setTickPosition(QSlider.TicksAbove)
slider_tau4.setTickInterval(10)
slider_tau4.setSingleStep(1)


def slider_tau4_amp_changed():
    global tau4_amp_range
    value = slider_tau4_amp_max.value()/100
    tau4_amp_range[1] = 0.05 + value
    line_edit_tau4_amp_max.setText(str(tau4_amp_range[1]))


def slider_marimba_amp_max_changed():
    global marimba_amp_range
    value = 0.5 + (slider_marimba_amp_max.value()/50)
    line_edit_marimba_amp_max.setText(str(value))
    marimba_amp_range[1] = value


def slider_pad_volume_max_changed():
    global pad_volume_range
    value = 5 + slider_pad_volume_max.value() / 10
    line_edit_pad_volume_max.setText(str(value))
    pad_volume_range[1] = value


def slider_tau4_changed():
    global tau
    value = 5 + (slider_tau4.value()/4)
    tau[3] = int(value)
    line_edit_tau4.setText(str(tau[3]))


label_tau4_amp_max = QLabel('seagulls amp max')
layout_right.addWidget(label_tau4_amp_max)
slider_tau4_amp_max.valueChanged.connect(slider_tau4_amp_changed)
layout_right.addWidget(slider_tau4_amp_max)
line_edit_tau4_amp_max = QLineEdit()
line_edit_tau4_amp_max.setText(str(tau4_amp_range[1]))
layout_right.addWidget(line_edit_tau4_amp_max)

label_marimba_amp_max = QLabel('marimba amp max')
layout_right.addWidget(label_marimba_amp_max)
slider_marimba_amp_max.valueChanged.connect(slider_marimba_amp_max_changed)
layout_right.addWidget(slider_marimba_amp_max)
line_edit_marimba_amp_max = QLineEdit()
line_edit_marimba_amp_max.setText(str(marimba_amp_range[1]))
layout_right.addWidget(line_edit_marimba_amp_max)

label_pad_volume_max = QLabel('pad volume max')
layout_right.addWidget(label_pad_volume_max)
slider_pad_volume_max.valueChanged.connect(slider_pad_volume_max_changed)
layout_right.addWidget(slider_pad_volume_max)
line_edit_pad_volume_max = QLineEdit()
line_edit_pad_volume_max.setText(str(pad_volume_range[1]))
layout_right.addWidget(line_edit_pad_volume_max)

label_tau4 = QLabel('tau for seagulls')
layout_right.addWidget(label_tau4)
slider_tau4.valueChanged.connect(slider_tau4_changed)
layout_right.addWidget(slider_tau4)
line_edit_tau4 = QLineEdit()
line_edit_tau4.setText(str(tau[3]))
layout_right.addWidget(line_edit_tau4)
...
def sonification_algomusic_one(self):
    ...
    volume_scale = scn.linlin(volume_val, 0, volume_max, pad_volume_range[0], pad_volume_range[1])
    volume_scale = np.clip(volume_scale, pad_volume_range[0], pad_volume_range[1])
